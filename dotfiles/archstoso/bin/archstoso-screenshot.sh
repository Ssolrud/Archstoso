...
# Load Settings
if [ -f ~/.config/archstoso/settings/screenshot-folder ]; then
    SAVE_DIR=$(cat ~/.config/archstoso/settings/screenshot-folder)
fi
if [ -f ~/.config/archstoso/settings/screenshot-filename ]; then
    SAVE_FILENAME=$(cat ~/.config/archstoso/settings/screenshot-filename)
fi
