...
declare -A LISTENERS
LISTENERS["gtk-theme-switcher"]="$HOME/.config/archstoso/listeners/gtk-theme-switcher.sh"
LISTENERS["low-bat-notification"]="$HOME/.config/archstoso/listeners/low-bat-notification.sh"
